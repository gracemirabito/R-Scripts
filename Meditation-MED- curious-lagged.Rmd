...
MRS.data <- EMA.subset[,c("GROUP", "ID","TIME2","Time.C","Curiousity.C","PROMIS.C", "PhysicalActivity.C")]
#look at  data set
#head(MRS.data)
#tail(MRS.data)
...
datalong.part1 <- reshape2:: melt(data=df,
                 id.vars=c("GROUP", "ID","TIME2","Time.C","Curiousity.C","PA.lag","Depression.lag","X.M"),
...
model_lme.part1 <- lme(fixed = z ~ -1 + 
                             ...
                             dy + dy:PA.lag + dy:Curiousity.C + dy:Time.C, #y as outcome
